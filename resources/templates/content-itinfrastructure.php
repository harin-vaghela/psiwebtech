      ...
      <section class="primary row span_12 about-content grey_line">				                                    
        <article class="col span_8">
          ...
          <p class="article_block_text"><b>Enterprise Management</b> - identify and prioritize the most cost efficient IT projects for your company</p>
            ...
            <p class="article_block_text"><b>Network Management</b> - We can help you cost-effectively build out a common communications framework for running traditional and virtual networks.</p>
            <ul>
              <li>> Managed WAN/LAN Service</li>
              <li>> Managed VPN Service</li>
              <li>> Managed IP Telephony Services</li>
              <li>> VoIP Management</li>
              <li>> Wireless</li>
              <li>> Traffic/Bandwidth</li>
              <li>> Performance Management</li>                                                                                                                
            </ul>   
            <p class="article_block_text"><b>End User Management</b> - Our team of IT professionals can help you simplify and streamline your computing environment to reduce costs and increase service quality.</p>
            <ul>
              <li>> IT Help Desk Service</li>
              <li>> Remote Desktop Management</li>
              <li>> Desk-Side Support</li>
              <li>> Managed Exchange Service</li>
              <li>> Managed Active Directory Service</li>
            </ul>                                              				            
        </article>      
        <article class="col span_4">
          <h2 class="block  black_line">Services</h2> 
          <p class="block_text">Your business deserves the best IT and telecoms innovations. At PSI, we're truly focused on understanding and meeting your needs, with our longstanding expertise and vendor-independence underpinning our pioneering services.</p>				            
